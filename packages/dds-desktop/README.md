...
```bash
# npm 사용 시
npm install @dds-lab/desktop

# yarn 사용 시
yarn add @dds-lab/desktop
```

#### 의존성 설치

`@dds-lab/desktop`은 아래 패키지를 peer dependency로 사용합니다.
...
```tsx
// main.tsx
import '@dds-lab/desktop/desktop.css'
import App from './App'
...
```tsx
import { Button } from '@dds-lab/desktop'
